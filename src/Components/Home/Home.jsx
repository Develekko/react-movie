...
export default function Home() {
  ...
  let { TrendingAll, getCurrentTrend, currentTrend, currentPopular, getPopularMovies, topRated, getTopRated, getComedy, comedy, anime, getAnime } = useContext(ApiData);
  ...
  return <>
    ...
    <div className="castDisplay container-fluid pt-2 animate__animated animate__fadeIn">
      ...
      {currentTrend.length > 0 ? <><Swiper
        ...
        className="mySwiper"
      >
        {currentTrend.filter(img => img.poster_path !== null).map((movie, index) => <SwiperSlide className='position-relative cardOverParent' key={index}><Link to={`/movie-details/${movie.id}/${currentTrend[0].name ? 'tv' : 'movie'}`}><img className='img-fluid' src={imgPath + movie.poster_path} title={movie?.name || movie?.title} alt={movie?.name || movie?.title} /><div className='cardOverlay'><i onClick={(e) => { setFav(movie); e.preventDefault() }} className={'fa-solid fa-heart fs-5 me-2 ' + (itemList?.filter(x => x.id === movie.id).length > 0 ? 'text-danger animate__animated animate__fadeIn' : null)}></i> </div></Link></SwiperSlide>)}
      </Swiper></> : <Loading />}
    </div>
    ...
    <div className="castDisplay container-fluid pt-2 animate__animated animate__fadeIn">
      ...
      {currentPopular.length > 0 ? <><Swiper
        ...
        className="mySwiper"
      >
        {currentPopular.filter(img => img.poster_path !== null).map((movie, index) => <SwiperSlide className='position-relative cardOverParent' key={index}><Link to={`/movie-details/${movie.id}/${currentPopular[0].name ? 'tv' : 'movie'}`}><img className='img-fluid' src={imgPath + movie.poster_path} title={movie?.name || movie?.title} alt={movie?.name || movie?.title} /><div className='cardOverlay'><i onClick={(e) => { setFav(movie); e.preventDefault() }} className={'fa-solid fa-heart fs-5 me-2 ' + (itemList?.filter(x => x.id === movie.id).length > 0 ? 'text-danger animate__animated animate__fadeIn' : null)}></i> </div></Link></SwiperSlide>)}
      </Swiper></> : <Loading />}
    </div>
    ...
    <div className="castDisplay container-fluid pt-2 animate__animated animate__fadeIn">
      ...
      {topRated.length > 0 ? <><Swiper
        ...
        className="mySwiper"
      >
        {topRated.filter(img => img.poster_path !== null).map((movie, index) => <SwiperSlide className='position-relative cardOverParent' key={index}><Link to={`/movie-details/${movie.id}/${topRated[0].name ? 'tv' : 'movie'}`}><img className='img-fluid' src={imgPath + movie.poster_path} title={movie?.name || movie?.title} alt={movie?.name || movie?.title} /><div className='cardOverlay'><i onClick={(e) => { setFav(movie); e.preventDefault() }} className={'fa-solid fa-heart fs-5 me-2 ' + (itemList?.filter(x => x.id === movie.id).length > 0 ? 'text-danger animate__animated animate__fadeIn' : null)}></i> </div></Link></SwiperSlide>)}
      </Swiper></> : <Loading />}
    </div>
    ...
    <div className="castDisplay container-fluid pt-2 animate__animated animate__fadeIn">
      ...
      {comedy.length > 0 ? <><Swiper
        ...
        className="mySwiper"
      >
        {comedy.filter(img => img.poster_path !== null).map((movie, index) => <SwiperSlide className='position-relative cardOverParent' key={index}><Link to={`/movie-details/${movie.id}/${comedy[0].name ? 'tv' : 'movie'}`}><img className='img-fluid' src={imgPath + movie.poster_path} title={movie?.name || movie?.title} alt={movie?.name || movie?.title} /><div className='cardOverlay'><i onClick={(e) => { setFav(movie); e.preventDefault() }} className={'fa-solid fa-heart fs-5 me-2 ' + (itemList?.filter(x => x.id === movie.id).length > 0 ? 'text-danger animate__animated animate__fadeIn' : null)}></i> </div></Link></SwiperSlide>)}
      </Swiper></> : <Loading />}
    </div>
    ...
    <div className="castDisplay container-fluid pt-2 animate__animated animate__fadeIn">
      ...
      {anime.length > 0 ? <><Swiper
        ...
        className="mySwiper"
      >
        {anime.filter(img => img.poster_path !== null).map((movie, index) => <SwiperSlide className='position-relative cardOverParent' key={index}><Link to={`/movie-details/${movie.id}/${anime[0].name ? 'tv' : 'movie'}`}><img className='img-fluid' src={imgPath + movie.poster_path} title={movie?.name || movie?.title} alt={movie?.name || movie?.title} /><div className='cardOverlay'><i onClick={(e) => { setFav(movie); e.preventDefault() }} className={'fa-solid fa-heart fs-5 me-2 ' + (itemList?.filter(x => x.id === movie.id).length > 0 ? 'text-danger animate__animated animate__fadeIn' : null)}></i> </div></Link></SwiperSlide>)}
      </Swiper></> : <Loading />}
    </div>
  </>
}
